(#S(MANIFEST-PACKAGE
 ...
 #S(MANIFEST-PACKAGE :NAME "rt" :VC "kmr-git" :LOCATIONS (("latest" . "rt")))
 #S(MANIFEST-PACKAGE
    :NAME "rpm"
    :VC "git"
 ...
 #S(MANIFEST-PACKAGE :NAME "rlc" :VC "kmr-git" :LOCATIONS (("latest" . "rlc")))
 #S(MANIFEST-PACKAGE
 ...
 #S(MANIFEST-PACKAGE :NAME "lml" :VC "kmr-git" :LOCATIONS (("latest" . "lml")))
 #S(MANIFEST-PACKAGE
    :NAME "lla"
    :VC "git"
